...
const ResetPassword = () => {
    ...
    let handleSubmit = async (e) => {
        ...
        try {
            ...
            toast.success(`Password reset link has been sent to your registered ${ email } address`);
            navigate("/auth/login");
        } catch (error) {
                    ...
                    >
                        ...
                        <div className="p-2 flex justify-between">
                            ...
                            <span>
                                <Link
                                    to="/auth/login"
                                    className="text-white bg-slate-500 px-2 py-1 text-sm rounded-sm hover:bg-pink-600 border-purple-700 border-b"
                                >
                                    Login
                                </Link>
                            </span>
